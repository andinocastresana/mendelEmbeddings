...
| 6  | Implementar **calibración de umbrales** sobre KinFaceW-I/II — estimar umbral data-driven para coseno y euclídea. **Fase A (calibración Python) hecha 2026-05-23** (`src/phyloface/benchmark/` + `scripts/run_calibration_kinfacew.py`): 5-fold CV oficial, umbral Youden por relación, AUC; KinFaceW-I AUC 0.727 / acc 66.6% (FS 73% → MS 60%), artefacto JSON con histogramas. Resta: **Fase B** (visualización web: solapa de histogramas + modal que ubica el cosine propio — en otra sesión), correr KinFaceW-II con disclaimer de sesgo, y opcional cabeza MLP (Mejora 2 del informe). Ver `_meta/CALIBRACION_TAREA6.md`. | M1.6, B | en progreso | 2026-05-19 | 2026-05-23 |
